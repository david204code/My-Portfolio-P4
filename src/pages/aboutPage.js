  ...
  <div className="container-fluid">
    <div className="container">
      ...
      <p className="intro-part2">
        ...
        forward to learn next skills and ultimately use those skills to develope
        visually pleasing web content.
        <br />I am a Christian, who love Jesus and accepted him as my Lord and
        Savivor. I also play football and enjoy listening to worship songs. I
        like to watch movies in my spare time, mainly action or thriller films.
        Mostly I watch football clips on Youtube.
      </p>
